...
class Customer {
  ...
  case class Customer(
                       ...
                       //被拒绝总次数
                       totals_bounces: Option[String],
                       //单曲总数
                       totals_hits: String,
                       //新访问总数
                       totals_newVisits: Option[String],
                       //网页浏览次数
                       totals_pageviews: Option[String],
                       //交易总收入
                       totals_transactionRevenue: Option[String],
                       ...
                       //是否直接访问
                       trafficSource_isTrueDirect: Option[String],
                       //
