...
trait RecordFeatures {
  ...
  val features = Seq(card_id, first_active_month, feature_1, feature_2, feature_3, new_installments_sum_stddev, new_installments_sum_avg, new_installments_min_stddev, new_installments_min_avg, new_installments_max_stddev, new_installments_max_avg, new_installments_std_stddev, new_installments_std_avg, new_purchase_amount_sum_stddev, new_purchase_amount_sum_avg, new_purchase_amount_min_stddev, new_purchase_amount_min_avg, new_purchase_amount_max_stddev, new_purchase_amount_max_avg, new_purchase_amount_std_stddev, new_purchase_amount_std_avg, new_category_1_avg, new_category_1_std, new_category_2_avg, new_category_2_std, new_city_id_count, new_state_id_count, new_subsector_id_count, new_month_lag_avg, auth_installments_sum_stddev, auth_installments_sum_avg, auth_installments_min_stddev, auth_installments_min_avg, auth_installments_max_stddev, auth_installments_max_avg, auth_installments_std_stddev, auth_installments_std_avg, auth_purchase_amount_sum_stddev, auth_purchase_amount_sum_avg, auth_purchase_amount_min_stddev, auth_purchase_amount_min_avg, auth_purchase_amount_max_stddev, auth_purchase_amount_max_avg, auth_purchase_amount_std_stddev, auth_purchase_amount_std_avg, auth_category_1_avg, auth_category_1_std, auth_category_2_avg, auth_category_2_std, auth_city_id_count, auth_state_id_count, auth_subsector_id_count, auth_month_lag_avg, hist_installments_sum_stddev, hist_installments_sum_avg, hist_installments_min_stddev, hist_installments_min_avg, hist_installments_max_stddev, hist_installments_max_avg, hist_installments_std_stddev, hist_installments_std_avg, hist_purchase_amount_sum_stddev, hist_purchase_amount_sum_avg, hist_purchase_amount_min_stddev, hist_purchase_amount_min_avg, hist_purchase_amount_max_stddev, hist_purchase_amount_max_avg, hist_purchase_amount_std_stddev, hist_purchase_amount_std_avg, hist_category_1_avg, hist_category_1_std, hist_category_2_avg, hist_category_2_std, hist_city_id_count, hist_state_id_count, hist_subsector_id_count, hist_month_lag_avg)
    .transmogrify ()
}
