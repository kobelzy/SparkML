...
//                    }
    ...
    //如果没有join到，会使用null进行代替。
//                           .map{case Row(user_id:Int, sku_id:Int ,a_date:Timestamp,a_num:Int,a_type:Int,o_user_id:Int,o_sku_id:Int,o_date:Timestamp,o_sku_num:Int)=>
//               user_id match {
//                   case null =>
//               }
//           }
...
//                       case Row(user_id:Int, sku_id:Int ,a_date:Timestamp,a_num:Int,a_type:Int,o_user_id:Int,o_sku_id:Int,o_date:Timestamp,o_sku_num:Int)=>
                       ...
                       (userID,date,sku,aType,aNum,oNum)
           }
...
//                case Row(user_id:Int, sku_id:Int ,a_date:Timestamp,a_num:Int,a_type:Int,o_user_id:Int,o_sku_id:Int,o_date:Timestamp,o_sku_num:Int)=>
    ...
    val order2action_df=orderNotNull_df.union(actionNotNull_df).toDF("user_id","date","sku_id","a_type","a_num","o_num")
